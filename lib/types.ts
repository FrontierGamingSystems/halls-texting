...
export type Message={id:string;sender:string;body:string;receivedAt:string;day:string;hallId:string|null;candidates:string;status:string;kind:string};
export type Snapshot={halls:Hall[];messages:Message[];lastSync:string|null;connected:boolean;cityCount:number};
